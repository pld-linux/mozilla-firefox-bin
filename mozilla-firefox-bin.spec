...
# Source0-md5:	2f72e5f77ad35d25e6aaf850fa0da38b
...
grep -v 'libfreeblpriv3\|libnspr4.so\|libplc4.so\|libplds4.so\|libnssutil3.so\|libnss3.so\|libsmime3.so\|libssl3.so' \
