...
# Source0-md5:	71141a1bd8a296f636185666a90e39cb
...
# Source1-md5:	2ab7465a8e212d6d11cceb8eec6cd8de
...
Requires:	nss >= 1:3.40.1
%{?with_system_sqlite:Requires:	sqlite3 >= 3.25.1}
Suggests:	pulseaudio
Provides:	wwwbrowser
...
%define		moz_caps	libmozalloc.so libmozavcodec.so libmozavutil.so libclearkey.so liblgpllibs.so libmozgtk.so libmozsandbox.so libmozsqlite3.so libxpcom.so libxul.so
